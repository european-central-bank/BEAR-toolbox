...
% needs.
%
% Generated 02-Mar-2026 01:20:18
%
...
figureHandles = chartpack.responsePercentiles( ...
    ...
    , "figureLegend", percentilesLegend ...
    , "chartSettings", {"timeAxis", "integers", "referencePeriod", responseSpan(1)} ...
);
...
figureHandles = chartpack.contributionsMedian( ...
    fevdMedianTbl, structModel ...
    , "figureTitle", "Forecast error variance decomposition (median)" ...
    , "chartSettings", {"timeAxis", "integers", "referencePeriod", fevdSpan(1)} ...
);

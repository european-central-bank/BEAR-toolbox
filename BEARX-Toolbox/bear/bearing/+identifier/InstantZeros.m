    ...
    methods (Static)
        function checkTable(restrictionsTable, meta)
            ...
            if numRestrictions > maxNumRestrictions
                error( ...
                    "InstantZeros allows at most %g exact zero restrictions for %g endogenous variables " + ...
                    "(formula: n(n-1)/2 - 1). Use the Cholesky identifier instead if you want a fully " + ...
                    "recursive identification with exactly n(n-1)/2 zeros." ...
                    , maxNumRestrictions, numVariables ...
                );
            end
        end%
    end

function [cforecast_record] = conditionalForecastPanel(this, meta, fcastStart, fcastEnd, longYXZ, cfcondsFull, cfshocksFull, cfblocksFull)
    ...
    for indCountry = 1:numCountries
        ...
        if nconds~=0
            ...
            for indSample = 1:numPresampled
                ...
                fmat=bear.forecastsim(shortY(:,:,indCountry),shortXpred,beta,numEndog,numLags,numBRows,Fperiods);

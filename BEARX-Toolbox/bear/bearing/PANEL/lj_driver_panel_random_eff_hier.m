...
for iteration=1:numt % beginning of forecasting loop
  if window_size>0
    ...
    numLags = lags;
    % get sampler
    outSampler = lj_panel_rand_eff_hier_smpl(data_endo,data_exo,const,lags,lambda2,lambda3,lambda4,s0,v0, Bu);
    ...
    [B,Sigma] = lj_panel_rand_eff_drawer(smpl,numCountries,numEndog,numLags,numExog);

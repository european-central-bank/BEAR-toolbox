...
if favar.transformation==1 || favar.plot_transform==1 %second condition is determined in bear.favar_gensample1
...
% demean
[favar.data_exfactors]=bear.favar_demean(favar.data_exfactors);
% save demeaned data before standardising
favar.data_exfactors_temp=favar.data_exfactors;

% standardise data
[favar.data_exfactors]=bear.favar_standardise(favar.data_exfactors);

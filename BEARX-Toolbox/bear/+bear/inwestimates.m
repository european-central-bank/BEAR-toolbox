function [beta_median beta_std beta_lbound beta_ubound sigma_median]=inwestimates(beta_gibbs,sigma_gibbs,cband,q,n,k)



% function [beta_median beta_std beta_lbound beta_ubound sigma_median]=mxestimates(beta_gibbs,sigma_gibbs,cband,q,n,k)
% estimates the posterior mean, standard deviation and confidence interval for the VAR coefficients  (mixed prior)

...
function [favar] = initializeFAVARTwoStep(meta, longYX, longZ)
    ...
    %gensample 1
    [favar] = bear.ogr_favar_twostep_gensample1(favar, meta);

    %gensample2
    endo = [meta.FactorNames, meta.EndogenousNames];
    [data, favar] = bear.ogr_favar_twostep_gensample2(favar.Y, endo, p, favar);

    % gensample 3
    [favar] = bear.ogr_favar_twostep_gensample3(data, favar);

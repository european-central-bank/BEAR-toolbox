...
dataFile = fullfile(bearroot(), 'replications','data_AAU2009.xlsx');
if ~isfile(dataFile)
    websave(dataFile, 'https://github.com/european-central-bank/BEAR-toolbox/raw/refs/heads/BEAR6-staging/data/bear5/replications/data_AAU2009.xlsx')
end

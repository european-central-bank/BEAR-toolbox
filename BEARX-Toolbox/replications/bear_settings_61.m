function s = bear_settings_61()
% testing prior 61

% general data and model information
dataFile = fullfile(bearroot(), 'replications','data_61.xlsx');
if ~isfile(dataFile)
    websave(dataFile, 'https://github.com/european-central-bank/BEAR-toolbox/raw/refs/heads/BEAR6-staging/data/bear5/replications/data_61.xlsx')
end
...
s.HD=1; s.HDall=0;%if we want to plot the entire decomposition, all contributions (includes deterministic part)HDall

...
% function []=bear.irfdisp(n,endo,IRFperiods,IRFt,irf_estimates,D_estimates,gamma_estimates,datapath)
...
if pref.results==1
    ...
    % write in excel
    bear.xlswritegeneral(fullfile(pref.results_path, [pref.results_sub '.xlsx']),IRFcell,'favar_IRF time variation','B2');
end
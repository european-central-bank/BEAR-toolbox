function[success]=CheckFEVDrestriction(ortirfmatrix,gamma,IRFperiods,n,rowrelativeFEVD,clmrelativeFEVD,rowabsoluteFEVD,clmabsoluteFEVD,FEVDresperiods,rowsFEVD,nFEVDresX) 
...
%loop over variables
for yy=1:length(rowsFEVD)  %rowsFEVD are the variables with FEVD restriction
FEVDofVariable = nan(n,IRFperiods);
% extract FEVD of that variable
FEVDofVariablecell=fevd_estimates(rowsFEVD(yy,1),:);
for xx=1:n

function [fevd_record,fevd_estimates]=panel3fevd(N,struct_irf_record,gamma_record,It,Bu,IRFperiods,n,FEVDband)
...
for ii=1:N
[fevd_record(:,:,ii)]=bear.fevd(struct_irf_record(:,:,ii),gamma_record(:,:,ii),It,Bu,n,IRFperiods,FEVDband);

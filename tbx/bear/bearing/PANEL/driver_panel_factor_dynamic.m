  ...
  if window_size>0
    ...
    if CF==1
      [cforecast_record, cforecast_estimates]=...
        bear.panel6cf(N,n,m,p,k,d,cfconds,cfshocks,cfblocks,It,Bu,Fperiods,const,Xi,data_exo_p,theta_gibbs,B_gibbs,phi_gibbs,Zeta_gibbs,sigmatilde_gibbs,Fstartlocation,Ymat,rho,thetabar,gamma,CFt,Fband);

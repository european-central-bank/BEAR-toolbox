...
for j=windowSize:1:T; 
    ...
    result=bear.GR_PF_DMtest(sq_forcast_error_model,sq_forcast_error_bench,max_nlag);        % 2018_06_18: conduct test on squared FE differences
        
    % result=bear.GR_PF_DMtest(y1(j-windowSize+1:j),y(j-windowSize+1:j),max_nlag);
DM=result.teststat;  

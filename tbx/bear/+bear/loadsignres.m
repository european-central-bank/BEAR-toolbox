...
if pref.results==1
    xlswritegeneral(fullfile(pref.results_path, [pref.results_sub '.xlsx']),strngs1,'sign res values','B2');
    xlswritegeneral(fullfile(pref.results_path, [pref.results_sub '.xlsx']),strngs2,'sign res periods','B2');
end
end

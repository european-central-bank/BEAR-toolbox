...
% % %         end
        if IRFt==5
        [D,D1ols]=bear.irfiv_ols_for_bootstrap_GK(txt,names,IVrotate,betadraw,n,Xdraw,Ydraw,k,p,enddate,startdate,cut1,cut2,cut3,cut4);
        % Step 5: Calculate impulse responses and store them
        [~,ortirfmatrix]=bear.irfsim(betadraw,D,n,m,p,k,IRFperiods);
       for jj=1:IRFperiods

...
if favar.transformation==1
    for ii=1:favar.nfactorvar
        favar.informationdata(:,ii)=bear.favar_transx(informationdata2(:,ii),favar.transformationindex(ii,1));
    end

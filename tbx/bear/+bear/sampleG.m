...
for i=1:Mz
    ...
    % sample states
    [yStarAdj, Ht] = bear.statesMix(yStar,lnSigma2); %get the mean and variance adjusted mixture of the states
    ...
    % sample phi
    [phiDraw_Gi]=bear.samplePhi(logVarsDraw_Gi,priorD_G,priorPhi_G);

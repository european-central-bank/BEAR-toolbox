...
% function [irf_estimates,D_estimates,gamma_estimates]=bear.irfestimates(irf_record,n,IRFperiods,IRFband,IRFt,D_record,gamma_record)
...
if strctident.MM==0
    ...
    if favar.FAVAR==1
        if favar.transformation==1 || favar.plot_transform==1
            ...
            % re-transform
            [favar_irf_record]=bear.favar_retransX_irf_record(favar_irf_record,transformationindex,favar.levels);
            % save
            ...
            % re-transform
            [irf_record]=bear.favar_retransX_irf_record(irf_record,transformationindex_endo,favar.levels);
        end
    end

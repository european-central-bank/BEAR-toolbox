...
ss_record=bear.ssgibbs(n,m,p,k,Xi(:,:,1),beta_gibbs,It,Bu,favar);
% % % run the Gibbs sampler for the steady-state constant part (common to all units)
% % ss_record_constant=bear.ssgibbs(n,m,p,k,Xi(:,:,1),beta_gibbs,It,Bu,favar);
% % % run the Gibbs sampler for the steady-state constant part (common to all units)
% % ss_record_exogenous=bear.ssgibbs(n,m,p,k,Xi(:,:,1),beta_gibbs,It,Bu,favar);

...
if favar_FAVAR==1
    ...
    if favar.transformation==1 || favar.plot_transform==1
        ...
        % re-transform
        [favar_irf_record_allt]=bear.favar_retransX_irf_record(favar_irf_record_allt,transformationindex,favar.levels);
        % save
        ...
        % re-transform
        [irf_record_allt]=bear.favar_retransX_irf_record(irf_record_allt,transformationindex_endo,favar.levels);
    end

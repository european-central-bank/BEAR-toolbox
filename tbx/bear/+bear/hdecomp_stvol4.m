...
%[hd_estimates] = bear.hd_for_signres_stvol4(0,beta,k,n,p,D,m,T,Xdraw,Ydraw, data_exo, contributors, hd_estimates2, Psidrawcut, YincLags(2*p+1:end,:));
[hd_estimates] = bear.hd_for_signres_stvol4(0,exo,beta,k,n,p,D,m,T,Xdraw,Ydraw,data_exo,IRFt,signreslabels_shocks, Psidrawcut, YincLags(2*p+1:end,:))

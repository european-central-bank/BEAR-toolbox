function [fh,xh,gh,H,itct,fcount,retcodeh] = sims_csminwel(fcn,x0,H0,grad,crit,nit,varargin)
...
if f0 > 1e50, return, end
if NumGrad
   if length(grad)==0
      [g badg] = bear.sims_numgrad(fcn,x0, varargin{:});
      %ARGLIST
...
while ~done
   ...
   itct=itct+1;
   [f1 x1 fc retcode1] = bear.sims_csminit(fcn,x,f,g,badg,H,varargin{:});
   %ARGLIST
   ...
   if retcode1 ~= 1
      if retcode1==2 | retcode1==4
         ...
         if NumGrad
            [g1 badg1] = bear.sims_numgrad(fcn, x1,varargin{:});
            %ARGLIST
      ...
      if wall1 & (length(H) > 1)% 
         ...
         [f2 x2 fc retcode2] = bear.sims_csminit(fcn,x,f,g,badg,Hcliff,varargin{:});
         %ARGLIST
         ...
         if  f2 < f
            if retcode2==2 | retcode2==4
               ...
               if NumGrad
                  [g2 badg2] = bear.sims_numgrad(fcn, x2,varargin{:});
                  %ARGLIST
            ...
            if wall2
               if norm(x2-x1) < 1e-13
                  ...
                  [f3 x3 fc retcode3] = bear.sims_csminit(fcn,x,f,gcliff,0,eye(nx),varargin{:});
                  %ARGLIST
                  ...
                  if retcode3==2 | retcode3==4
                     ...
                     if NumGrad
                        [g3 badg3] = bear.sims_numgrad(fcn, x3,varargin{:});
                        %ARGLIST
   ...
   elseif f1 < f - crit & badg1==0
      ...
      if nogh
         if NumGrad
            [gh badgh] = bear.sims_numgrad(fcn,xh,varargin{:});
         else

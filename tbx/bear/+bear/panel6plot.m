...
% write in excel
if pref.results==1
    bear.xlswritegeneral(fullfile(pref.results_path, [pref.results_sub '.xlsx']),residcell,'resids','B2');
end
...
[ss_record,ss_estimates]=bear.ssgibbspan6(n,N,m,p,k,T,Xmat,theta_gibbs,Xi,It,Bu,cband);
if pref.plot
% then plot the figure
...
volatility=figure('Tag','BEARresults');
...
% write in excel
if pref.results==1
    bear.xlswritegeneral(fullfile(pref.results_path, [pref.results_sub '.xlsx']),tvcell,'time variation','B2');
end

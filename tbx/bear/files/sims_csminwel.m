...
if NumGrad
   if length(grad)==0
      [g badg] = sims_numgrad(fcn,x0, varargin{:});
      %ARGLIST
...
while ~done
   ...
   itct=itct+1;
   [f1 x1 fc retcode1] = sims_csminit(fcn,x,f,g,badg,H,varargin{:});
   %ARGLIST
   ...
   if retcode1 ~= 1
      if retcode1==2 | retcode1==4
         ...
         if NumGrad
            [g1 badg1] = sims_numgrad(fcn, x1,varargin{:});
            %ARGLIST
      ...
      if wall1 & (length(H) > 1)% 
         ...
         [f2 x2 fc retcode2] = sims_csminit(fcn,x,f,g,badg,Hcliff,varargin{:});
         %ARGLIST
         ...
         if  f2 < f
            if retcode2==2 | retcode2==4
               ...
               if NumGrad
                  [g2 badg2] = sims_numgrad(fcn, x2,varargin{:});
                  %ARGLIST
            ...
            if wall2
               if norm(x2-x1) < 1e-13
                  ...
                  [f3 x3 fc retcode3] = sims_csminit(fcn,x,f,gcliff,0,eye(nx),varargin{:});
                  %ARGLIST
                  ...
                  if retcode3==2 | retcode3==4
                     ...
                     if NumGrad
                        [g3 badg3] = sims_numgrad(fcn, x3,varargin{:});
                        %ARGLIST
   ...
   elseif f1 < f - crit & badg1==0
      ...
      if nogh
         if NumGrad
            [gh badgh] = sims_numgrad(fcn,xh,varargin{:});
         else

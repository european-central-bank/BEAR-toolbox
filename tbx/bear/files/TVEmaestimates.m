function [beta_median, beta_std, beta_lbound, beta_ubound, theta_median, theta_std, theta_lbound, theta_ubound, sigma_median]=TVEmaestimates(beta_gibbs,theta_gibbs,sigma_gibbs,cband,q1,q2,n);
...
theta_lbound(ii,:)=[quantile(theta_gibbs(ii,:),(1-cband)/2)];
theta_ubound(ii,:)=[quantile(theta_gibbs(ii,:),1-(1-cband)/2)];
end

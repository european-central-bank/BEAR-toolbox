...
%         data_endo = data_endo_full(iteration:window_size+iteration,:);
    ...
    [beta0, omega0, G, I_o, omega, f0, upsilon0]=stvol_prior_new(stvol,ar,arvar,lambda1,lambda2,lambda3,lambda4,lambda5,n,m,p,T,k,q,bex,blockexo,priorexo,gamma);
    ...
    [beta_gibbs, F_gibbs, ~ ,L_gibbs, phi_gibbs, sigma_gibbs, lambda_t_gibbs, sigma_t_gibbs, sbar]=...
            stvol_gibbs(stvol,Xbart,yt,beta0,omega0,alpha0,delta0,f0,upsilon0,betahat,sigmahat,I_o,omega,T,n,q,It,Bu,pick,pickf,gamma,G);
    ...
    %% BLOCK 5: FORECASTS
    [forecast_record]=forecaststvol(data_endo_a,data_exo_p,It,Bu,beta_gibbs,F_gibbs,phi_gibbs,L_gibbs,gamma,sbar,Fstartlocation,Fperiods,n,p,k,const);
    % compute posterior estimates

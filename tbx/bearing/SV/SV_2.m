...
%         data_endo = data_endo_full(iteration:window_size+iteration,:);
    ...
    [beta0, omega0, ~, I_o, omega, f0, upsilon0]=stvol_prior_new(stvol,ar,arvar,lambda1,lambda2,lambda3,lambda4,lambda5,n,m,p,T,k,q,bex,blockexo,priorexo);
    ...
    [beta_gibbs, F_gibbs, gamma_gibbs, L_gibbs, phi_gibbs, sigma_gibbs, lambda_t_gibbs, sigma_t_gibbs, sbar]=...
        stvol_gibbs(stvol,Xbart,yt,beta0,omega0,alpha0,delta0,f0,upsilon0,betahat,sigmahat,I_o,omega,T,n,q,It,Bu,pick,pickf,gamma0,zeta0);
   
    % compute posterior estimates
    [beta_median, beta_std, beta_lbound, beta_ubound, sigma_median, sigma_t_median, sigma_t_lbound, sigma_t_ubound,gamma_median]=stvol_estimates(beta_gibbs,sigma_gibbs,sigma_t_gibbs,n,T,cband,gamma_gibbs);
    ...
    %% BLOCK 5: FORECASTS
    [forecast_record]=forecaststvol(data_endo_a,data_exo_p,It,Bu,beta_gibbs,F_gibbs,phi_gibbs,L_gibbs,gamma_gibbs,sbar,Fstartlocation,Fperiods,n,p,k,const);
    % compute posterior estimates

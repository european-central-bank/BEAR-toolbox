function [logml log10ml ml]=nwmlikdata(X,n,T,k,phi0,S0,alpha0,Sbar,alphabar)



% function [logml log10ml ml]=bear.nwmlik(X,n,T,k,phi0,S0,alpha0,Sbar,alphabar)
...
temp1=(-n*T/2)*log(pi)+bear.mgamma(alphabar/2,n)-bear.mgamma(alpha0/2,n);

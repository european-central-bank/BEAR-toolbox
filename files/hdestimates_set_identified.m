...
for ii=1:favar.npltX
   ...
   for jj=1:length(favar.HD.favar_hd_record)
      ...
      for kk=1:T
        favar.HD.hd_estimates{jj,ii}(1,kk)=quantile(favar.HD.favar_hd_record{jj,ii}(:,kk),0.5);
      end
   end
end
end
...
for ii=1:favar.npltX
   ...
   for jj=1:length(favar.HD.favar_hd_record)
      % consider sample periods in turn
      for kk=1:T
        favar.HD.hd_estimates{jj,ii}(1,kk)=favar.HD.favar_hd_record{jj,ii}(medianmodel,kk);
      end
   end
end
end

function [forecast_record]=forecast(data_endo_a,data_exo_p,It,Bu,beta_gibbs,sigma_gibbs,Fperiods,n,p,k,const,Fstartlocation,favar)
...
if favar.FAVAR==1
    FAVAR=1;
    FY_gibbs=reshape(favar.FY_gibbs,size(favar.X,1),n,It-Bu);
else
    FAVAR=0;
end
...
if FAVAR==1
   data_endo_a=squeeze(FY_gibbs(1:Fstartlocation-1,:,ii));
end

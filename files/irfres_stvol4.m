    ...
    if IRFt==4 && zerores==1 && signres==0 && magnres==0 && relmagnres==0 && favar_signres==0 && favar_magnres==0
        ...
        while success==0
            ...
            if size(Qj,2)==n && success==1  && checkCorrelInstrumentShock==1
                ...
                ETA=D\EPS';
                [success,corIV,pivShockwithIV,Qj]=CheckCorrelWithIV(ETA,n,CorrelShock_index, IVcorrel,OverlapIVcorrelinY(sizetraining+1:end,:),FlipCorrel,Qj);
%                 if success==1
...
%                   end 
            ...
            if size(Qj,2)==n && success==1 && HD==1
                ...
                [hd_estimates] = hd_for_signres_stvol4(const,exo,beta,k,n,p,D,m,T,Xdraw,Ydraw,data_exo,IRFt,signreslabels_shocks,Psidrawcut, YincLags(2*p+1:end,:));
            end
